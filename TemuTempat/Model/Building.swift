...
class Building: Identifiable {
    ...
    init(id: Int, name: String, desc: String, isFavorite: Bool, address: String, tags: [String], imageName: String, coordinates: Coordinates? = nil, operationalHours: String? = nil) {
        self.id = id
        self.name = name
        self.desc = desc
